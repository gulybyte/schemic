...
const SURQL_KEYWORDS = [
  'SELECT', 'FROM', 'WHERE', 'ORDER', 'BY', 'GROUP', 'LIMIT', 'START', 'FETCH', 'SPLIT',
  'AS', 'ASC', 'DESC', 'AND', 'OR', 'NOT', 'IN', 'CONTAINS', 'CREATE', 'UPDATE', 'DELETE',
  'RELATE', 'INSERT', 'UPSERT', 'CONTENT', 'SET', 'MERGE', 'RETURN', 'DEFINE', 'TABLE',
  'FIELD', 'INDEX', 'EVENT', 'FUNCTION', 'ACCESS', 'ON', 'TYPE', 'ASSERT', 'DEFAULT',
  'VALUE', 'PERMISSIONS', 'SCHEMAFULL', 'SCHEMALESS', 'UNIQUE', 'FLEXIBLE', 'IF', 'ELSE',
  'FOR', 'LET', 'BEGIN', 'COMMIT', 'TRANSACTION', 'WITH', 'INFO',
]

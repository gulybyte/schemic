import { Check, CircleX, Database, GitBranch, TriangleAlert } from 'lucide-react'
...
registerSegment({ id: 'branch', side: 'left', group: 'repo', title: 'Git branch', Component: Branch })
registerSegment({ id: 'migrations', side: 'left', group: 'repo', title: 'Migrations', Component: Migrations })
registerSegment({ id: 'ns-db', side: 'left', group: 'db', title: 'Namespace / Database', Component: NsDb })
registerSegment({ id: 'problems', side: 'left', group: 'diagnostics', title: 'Errors & warnings', Component: Problems })
registerSegment({ id: 'language', side: 'right', group: 'lang', title: 'Language mode', Component: Language })
registerSegment({ id: 'cursor', side: 'right', group: 'cursor', title: 'Cursor position', Component: Cursor })
registerSegment({ id: 'indentation', side: 'right', group: 'editor', title: 'Indentation', Component: Indentation })
registerSegment({ id: 'encoding', side: 'right', group: 'editor', title: 'Encoding', Component: Encoding })

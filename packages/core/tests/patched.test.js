...
describe("zod", () => {
    ...
    // @original
    // TODO: DB Validation?
    defineTest("stringFormat", z.stringFormat("lowercase", (value) => value.toLowerCase() === value), {
        type: "string",
        tests: [
            testCase({ value: "hello world", parse: { data: "hello world" } }),
            testCase({
    ...
    // @original
    defineTest("keyof { name: string, age: number }", z.keyof(z.object({ name: z.string(), age: z.number() })), {
        type: '"name" | "age"',
        tests: [
            testCase({ value: "name" }),
            testCase({ value: "age" }),
    ...
    // @original
    defineTest("object { name: string, age: number }", z.object({ name: z.string(), age: z.number() }), {
        type: "object",
        children: [
    ...
    defineTest("strict object { name: string, age: number | none }", z.strictObject({ name: z.string(), age: z.number().optional() }), {
        type: "object",
        children: [
            { name: "name", type: "string" },
    ...
    // @original
    defineTest("loose object { name: string, age: number }", z.looseObject({ name: z.string(), age: z.number() }), {
        type: "object",
        children: [
            { name: "name", type: "string" },
            { name: "age", type: "number" },
    ...
    describe("union", () => {
        ...
        defineTest("string | number | boolean", z.union([z.string(), z.number(), z.boolean()]), {
    ...
    describe("intersection", () => {
        ...
        "(string | number) & (string | boolean)", z.intersection(z.string().or(z.number()), z.string().or(z.boolean())), {
            // TODO: After finding a way to handle intersections
            // type: "string | number | bool",
            type: "any",
            tests: [
                ...
                testCase({
                    ...
                    parse: {
                        error: issues([
                            issue.invalid_union([issue.invalid_type("string")], [issue.invalid_type("boolean")]),
                        ]),
                    },
                }),
                // testCase({
        ...
        defineTest("[string, number]", z.tuple([z.string(), z.number()]), {
            ...
            tests: [
                ...
                testCase({
                    ...
                    error: /expected `\[string, number\]` but found `\[12345, 'Hello World'\]`/i,
                }),
            ],
        });
    ...
    describe("record", () => {
        defineTest(`record<"2025-01" | "2025-02" | "2025-03" | "2025-04", number>`, z.record(z.enum(["2025-01", "2025-02", "2025-03", "2025-04"]), z.number()), {
            type: "object",
        ...
        defineTest("record<number, number>", z.record(z.coerce.number(), z.number()), {
            type: "object",
            children: [{ name: "*", type: "number" }],
            tests: [
                testCase({
    ...
    describe("partial record", () => {
        defineTest(`partial record<"2025-01" | "2025-02" | "2025-03" | "2025-04", number>`, z.partialRecord(z.enum(["2025-01", "2025-02", "2025-03", "2025-04"]), z.number()), {
            type: "object",
            children: [{ name: "*", type: "number" }],
            tests: [
                testCase({
        ...
        defineTest("partial record<string, number>", z.partialRecord(z.string(), z.number()), {
            type: "object",
            children: [{ name: "*", type: "number" }],
            tests: [
                testCase({
        ...
        defineTest("partial record<number, number>", z.partialRecord(z.coerce.number(), z.number()), {
            type: "object",
            children: [{ name: "*", type: "number" }],
            tests: [
                testCase({
    ...
    describe("map", () => {
        ...
        defineTest("map<{ user_id: number }, number>", z.map(z.object({ user_id: z.number() }), z.number()), {
            type: "object",
            children: [{ name: "*", type: "number" }],
    ...
    // @original
    describe("enum", () => {
        defineTest("'active' | 'inactive' | 'pending'", z.enum(["active", "inactive", "pending"]), {
            ...
            tests: [
                ...
                testCase({
                    ...
                    error: /expected `'active' | 'inactive' | 'pending'` but found `'unknown'`/i,
                }),
            ],
        });
    });
    // @original
    describe("nativeEnum", () => {
        defineTest("nativeEnum<'active' | 'inactive' | 'pending'>", z.nativeEnum({
            active: "active",
            inactive: "inactive",
            pending: "pending",
        }), {
    ...
    describe("literal", () => {
        ...
        defineTest("'active' | 'inactive' | 'pending'>", z.literal(["active", "inactive", "pending"]), {
            type: `"active" | "inactive" | "pending"`,
            tests: [
                testCase({ value: "active", parse: { data: "active" } }),
    ...
    // @original
    defineTest("transform", z.transform((value) => value.toUpperCase()), {
        type: "any",
    });
    // @original
    ...
    // @original
    defineTest("pipe", z.pipe(z.string(), z.transform((value) => value.toUpperCase())), {
        type: "string",
        tests: [
            testCase({ value: "Hello World", parse: { data: "HELLO WORLD" } }),
        ],
    ...
    // @original
    // TODO: DB Validation?
    defineTest("template_literal", z.templateLiteral([z.literal("user."), z.enum(["age", "name"])]), {
        type: "string",
        tests: [
    ...
    defineTest("lazy", object, {
        ...
        tests: [
            ...
            testCase({
                ...
                parse: {
                    error: issues([
                        issue.invalid_union([issue.invalid_type("string")], [
